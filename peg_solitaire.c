...
int main(int argc, char *argv[])
{
  ...
  else
  {
    ...
    while (true)
    {
      ...
      // move = true if peg is selected
      move = (*board).selected;

      // For each case of keyboard input,
      switch (c)
      {
      case 97:  // 'a' key
      case 104: // 'h' key
      case 68:  // left arrow
        ...
        // success = true if:
        // (1) selected = true, and a valid move to move the peg is made
        // (2) selected = false, and a valid change of cursor position is made
      ...
      case 13: // enter key
        ...
        // success = true, if the cursor is over a peg and board->selected == false
        // success = false, if the cursor is not over a peg, or if the cursor is over a peg and
        // board->selected == true.
