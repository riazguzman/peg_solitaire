...
bool can_apply(state_t *board, position_s *selected_peg, move_t jump)
{
  ...
  // Can select a Peg
  if (board->field[selected_peg->x][selected_peg->y] != 'o')
    return false;
  ...
  case up:
    if (selected_peg->y < 2)
      return false;
    if (board->field[selected_peg->x][selected_peg->y - 1] != 'o')
      return false;
    if (board->field[selected_peg->x][selected_peg->y - 2] != '.')
      return false;
    break;

  case down:
    if (selected_peg->y > SIZE - 3)
      return false;
    if (board->field[selected_peg->x][selected_peg->y + 1] != 'o')
      return false;
    if (board->field[selected_peg->x][selected_peg->y + 2] != '.')
  ...
  case left:
    if (selected_peg->x < 2)
      return false;
    if (board->field[selected_peg->x - 1][selected_peg->y] != 'o')
      return false;
    if (board->field[selected_peg->x - 2][selected_peg->y] != '.')
      return false;
    break;

  case right:
    if (selected_peg->x > SIZE - 3)
      return false;
    if (board->field[selected_peg->x + 1][selected_peg->y] != 'o')
      return false;
    if (board->field[selected_peg->x + 2][selected_peg->y] != '.')
